        ...
        <form method="post" action="">
            ...
            <div class="form-row">
                <div class="form-inline  p-3 col">
                    <div class="form-group">
                        ...
                        <input type="text" class="form-control mx-sm-3 border-bottom" style="border: 0;" name="receiver" id="receiver" placeholder="Nama penerima" name="receiver" required value="<?= set_value('receiver') ?>">
                    </div>
                </div>
                <div class="form-inline  p-3 col">
                    <div class="form-group">
                        <label for="tlp" class="font-weight-bold">No. Tlp/Hp </label>
                        <input type="number" class="form-control mx-sm-3 border-bottom" style="border: 0;" name="tlp" id="tlp" placeholder="0812" required value="<?= set_value('tlp') ?>">
                    </div>
                </div>
            </div>
            ...
            <div class="form-row p-3">
                <div class='form-group col-md-6'>
                    ...
                    <textarea class="form-control" id="exampleFormControlTextarea1" placeholder="Jl. Kotep" name="saddress" rows="3" required></textarea>
                </div>
                <div class="col-md-6 ">
