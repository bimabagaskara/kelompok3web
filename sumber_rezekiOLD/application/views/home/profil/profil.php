        ...
        <div class="row">
            ...
            <div class="col-md-6">
                <div class="profile-head">
                    ...
                    $this->db->from('orders');
                    ?>
                    <p class="proile-rating">Status : <span class="badge badge-pill badge-success text-white">Active</span></p>
                            ...
                            <div class="col-md-8">
                                <table class="table table-borderless ">
                                    <?php foreach ($order as $o) { ?>
                                        <tr>
                                            <td><a href="<?= base_url('history_order/detail/') . $o['id_order'] ?>">#<?= $o['id_order'] ?></a>
                                            </td>
